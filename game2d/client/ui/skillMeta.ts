...
import {
  ...
  SHAMAN_ENHANCE_DAMAGE_BASE_BONUS,
  FIRE_BOLT_SKILL,
  WATER_BOLT_SKILL,
  AIR_BOLT_SKILL,
  EARTH_BOLT_SKILL,
  ...
  BATTLEMAGE_ENHANCED_DAMAGE_BASE_BONUS,
...
export const SKILL_DESCRIPTIONS: Record<string, string> = {
  ...
  [BATTLEMAGE_ENHANCED_ARMOR_SKILL]: `Battlemage-only: a chance (scaling with skill percent) to reduce a hit you take from a monster by ${BATTLEMAGE_ENHANCED_ARMOR_BASE_BONUS} or more (grows with your own level, strength, dexterity, and current armor vs physical). Grows every hit you take, landed or avoided.`,
  [BATTLEMAGE_ENHANCED_DAMAGE_SKILL]: `Battlemage-only: a chance (scaling with skill percent) to add +${BATTLEMAGE_ENHANCED_DAMAGE_BASE_BONUS} or more to a ranged/physical attack you make (grows with your own level, intelligence, and strength). Grows every attack you make, hit or miss.`,
