...
const TEXTURE_KEYS: Record<SpriteKind, string> = {
  ...
  falcon: 'falcon',
  gobbler: 'gobbler',
  'gobbler necromancer': 'gobbler-necromancer',
  'gobbler warrior': 'gobbler-warrior',
  'gobbler chieftain': 'gobbler-chieftain',
  'coven witch': 'coven-witch',
  troll: 'troll',
  'rune beast': 'rune-beast',
  'woodland fairy': 'woodland-fairy',
  orc: 'orc',
  ogre: 'ogre',
  'crystal deer': 'crystal-deer',
  'crystal wyvern': 'crystal-wyvern',
  'runestone canyon dweller': 'runestone-canyon-dweller',
...
const SHEET_PATHS: Record<SpriteKind, string> = {
  ...
  wolf: '/wolf-spritesheet.png',
  moose: '/moose-spritesheet.png',
  falcon: '/falcon-spritesheet.png',
  gobbler: '/gobbler-spritesheet.png',
  'gobbler necromancer': '/gobbler-necromancer-spritesheet.png',
  'gobbler warrior': '/gobbler-warrior-spritesheet.png',
  'gobbler chieftain': '/gobbler-chieftain-spritesheet.png',
  'coven witch': '/coven-witch-spritesheet.png',
  troll: '/troll-spritesheet.png',
  'rune beast': '/rune-beast-spritesheet.png',
  'woodland fairy': '/woodland-fairy-spritesheet.png',
  orc: '/orc-spritesheet.png',
  ogre: '/ogre-spritesheet.png',
  'crystal deer': '/crystal-deer-spritesheet.png',
  'crystal wyvern': '/crystal-wyvern-spritesheet.png',
  'runestone canyon dweller': '/runestone-canyon-dweller-spritesheet.png',
