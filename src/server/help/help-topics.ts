...
const HELP_TOPICS: Record<string, string> = {
  ...
  parry:
    'A passive skill every race starts with at level 1 (1%). Only works while wielding a weapon — gives a chance to avoid an attack entirely, based on your level, strength, and parry percentage compared to your opponent\'s. Grows 2% of the time whenever it triggers.',
  dagger:
